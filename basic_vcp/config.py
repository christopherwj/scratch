...
class Config:
    ...
    VCP_MIN_CONSOLIDATION_DAYS = 5  # Minimum days for consolidation
    VCP_MAX_CONSOLIDATION_DAYS = 252  # Maximum days for consolidation
    VOLATILITY_CONTRACTION_THRESHOLD = 0.5  # BB width contraction threshold
    VOLUME_DECLINE_THRESHOLD = 0.3  # Volume decline threshold during consolidation
    ...
    BREAKOUT_PERCENTAGE = 0.02  # Percentage above resistance for breakout
